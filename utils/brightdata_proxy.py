...
# Load Bright Data environment variables
BRIGHTDATA_PROXY_URL = os.environ.get('BRIGHTDATA_PROXY_URL', 'http://brd-customer-hl_ed59da04-zone-scraping_browser1:9vopp69suv46@brd.superproxy.io:9222')
...
class BrightDataProxyManager:
    ...
    def get_brightdata_session(self) -> requests.Session:
        """Create a requests session with Bright Data proxy pre-configured"""
        ...
        logger.info(f"Initialized Bright Data session with proxy: {BRIGHTDATA_PROXY_URL.split('@')[0]}@***")
        return session
